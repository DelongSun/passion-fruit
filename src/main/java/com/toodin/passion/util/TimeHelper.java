...
public final class TimeHelper {
    ...
    public static final DateTimeFormatter DATE_TIME_MINUTE_3 = DateTimeFormatter.ofPattern("yyyy年MM月dd日");
    public static final DateTimeFormatter DATE_TIME_MINUTE_4 = DateTimeFormatter.ofPattern("yyyy年MM月dd日 HH时mm分");
    ...
    public static String formatDateTime(String dateTimeStr, DateTimeFormatter formatter) {
